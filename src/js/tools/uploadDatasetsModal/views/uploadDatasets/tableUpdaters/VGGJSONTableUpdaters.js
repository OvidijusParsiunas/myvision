...
import validateVGGJSONFormat from '../formatValidators/VGGJSONValidator';
import {
  ONE_ANNOTATION_FILE_ALLOWED_ERROR_MESSAGE, VALID_ANNOTATION_FILES_ARRAY,
  ACTIVE_ANNOTATION_FILE, IMAGE_FILES_OBJECT,
} from '../../../consts';
import { getDatasetObject, updateImageFileErrorStatus } from '../datasetObjectManagers/VGGJSONDatasetObjectManager';
...
function reValidateExistingAnnotations(annotationFiles) {
  annotationFiles.forEach((annotationFile) => {
    const validationResult = validateVGGJSONFormat(annotationFile);
...
function updateVGGJSONTables(parsedObj, validationResult) {
...
export { updateVGGJSONTables as default };
