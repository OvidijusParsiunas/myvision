// This file contains my older code for an attempt to support Mask R-CNN training data format
...
export {
  assignCanvasForDownloadingAnnotationsXML, downloadXML, downloadJSON,
};
