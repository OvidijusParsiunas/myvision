...
function setCanvasElementsChromium(stubElementArg, zoomOverflowElementArg,
...
export { changeElementPropertiesChromium, setCanvasElementsChromium, initialiseVariablesChromium };
